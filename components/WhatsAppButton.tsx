...
export default function WhatsAppButton({ phone }: WhatsAppButtonProps) {
  const whatsappUrl = `https://wa.me/${phone}?text=Hi, I would like to inquire about your products.`
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-6 bg-green-500 hover:bg-green-600 text-white p-3.5 rounded-full shadow-lg transition-colors z-50 flex items-center justify-center"
